...
function SpecialProductsDisplayOne() {
  return (
    <div className="border relative rounded-xl bg-[#D87D4A] flex flex-col justify-center items-center gap-10">
      <img
      ...
      <div className="z-10 p-5 flex flex-col mb-10 justify-center text-white items-center gap-10">
        <div className="text-center text-4xl font-extrabold tracking-widest">
          <h1 className="">ZX9</h1>
          <h1 className="">SPEAKER</h1>
        </div>
        <p className="text-center font-light text-lg tracking-wide">
